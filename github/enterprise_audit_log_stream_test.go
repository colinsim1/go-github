...
func TestEnterpriseService_CreateAuditLogStream(t *testing.T) {
	...
	stream, resp, err := client.Enterprise.CreateAuditLogStream(ctx, "e", config)
	if err != nil {
		t.Fatalf("CreateAuditLogStream returned error: %v", err)
	}
	if resp == nil {
		t.Fatal("expected non-nil HTTP response")
	}
	if stream == nil {
		t.Fatal("expected non-nil AuditLogStreamEntry")
	}
	if stream.ID != 1 {
...
func TestEnterpriseService_GetAuditLogStream(t *testing.T) {
	...
	got, resp, err := client.Enterprise.GetAuditLogStream(context.Background(), "e", 42)
	if err != nil {
		t.Fatalf("GetAuditLogStream returned error: %v", err)
	}
	if resp == nil {
...
func TestEnterpriseService_ListAuditLogStreams(t *testing.T) {
	...
	if err != nil {
		t.Fatalf("ListAuditLogStreams returned error: %v", err)
	}
	if resp == nil {
		t.Fatal("expected non-nil response")
	}
...
func TestEnterpriseService_DeleteAuditLogStream(t *testing.T) {
	...
	ctx := context.Background()
	resp, err := client.Enterprise.DeleteAuditLogStream(ctx, "e", 42)
	if err != nil {
		t.Fatalf("DeleteAuditLogStream returned error: %v", err)
	}
	if resp == nil {
		t.Fatal("expected non-nil response")
	}
